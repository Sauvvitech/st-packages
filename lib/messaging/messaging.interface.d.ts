...
export interface IParamsConsumeKafka {
    topicsHandlers: Array<ITopicHandler>;
...
export interface IProducer {
    ...
    produceMultipleMessages(paramsProducerKafka: IParamsProduceMultipleMessages): Promise<void>;
}
...
export interface IConfigsKafkaConsumerFactory {
    errorRetryDelayInSeconds?: number;
}
